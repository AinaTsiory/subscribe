package school.hei.subscribe.endpoint.event.consumer;
...
import school.hei.subscribe.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("school.hei.subscribe.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "school.hei.subscribe.service.event."
