...
import static school.hei.subscribe.endpoint.event.EventStack.EVENT_STACK_1;
...
import school.hei.subscribe.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "school.hei.subscribe.event1";
    return "school.hei.subscribe.event2";
  }
}
