...
public class SubscriptionCreatedService implements Consumer<SubscriptionCreated> {
    ...
    public void accept(SubscriptionCreated event) {
        // 1. Génère le PDF du billet à partir du HTML
        ...
        try {
            ...
            // Nettoyage du fichier temporaire, indispensable sur Lambda où /tmp
            // est partagé entre invocations et limité en taille.
            if (!pdfFile.delete()) {
